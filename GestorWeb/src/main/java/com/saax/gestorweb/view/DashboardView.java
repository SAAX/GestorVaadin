...
public class DashboardView extends VerticalLayout {
    ...
    private Component buildTopContainer() {
        ...
        MenuBar.MenuItem publicationsMenuItem = topMenu.addItem("<h3>" + PresenterUtils.getMensagensResource().getString("DashboardView.publicationsMenuItem") + "</h3>", null, null);

        MenuBar.MenuItem reportsMenuItem = topMenu.addItem("<h3>" + PresenterUtils.getMensagensResource().getString("DashboardView.reportsMenuItem") + "</h3>", null, null);
    ...
    private Component buildAutoFiltersContainer() {
        ...
        forecastFilterButton = new PopupButton(PresenterUtils.getMensagensResource().getString("DashboardView.forecastFilterButton"));
    ...
    private Table buildTaskTable() {
        ...
        configuraExpansaoColunaCodigo(taskTable, PresenterUtils.getMensagensResource().getString("DashboardView.taskTable.cod"));
        ...
        taskTable.addExpandListener(new Tree.ExpandListener() {
            ...
            public void nodeExpand(Tree.ExpandEvent event) {
                taskTable.setColumnWidth(
                        PresenterUtils.getMensagensResource().getString("DashboardView.taskTable.cod"),
                        taskTable.getColumnWidth(PresenterUtils.getMensagensResource().getString("DashboardView.taskTable.cod")) + 20);
            }
        });
        ...
        taskTable.addContainerProperty(PresenterUtils.getMensagensResource().getString("DashboardView.taskTable.cod"), Button.class, "");
        taskTable.setColumnWidth(PresenterUtils.getMensagensResource().getString("DashboardView.taskTable.cod"), 100);
        taskTable.addContainerProperty(PresenterUtils.getMensagensResource().getString("DashboardView.taskTable.title"), Button.class, "");
        taskTable.setColumnWidth(PresenterUtils.getMensagensResource().getString("DashboardView.taskTable.title"), 100);
        taskTable.addContainerProperty(PresenterUtils.getMensagensResource().getString("DashboardView.taskTable.name"), Button.class, "");
        taskTable.setColumnWidth(PresenterUtils.getMensagensResource().getString("DashboardView.taskTable.name"), 250);
        taskTable.addContainerProperty(PresenterUtils.getMensagensResource().getString("DashboardView.taskTable.company"), String.class, "");
        taskTable.setColumnWidth(PresenterUtils.getMensagensResource().getString("DashboardView.taskTable.company"), 160);
        taskTable.addContainerProperty(PresenterUtils.getMensagensResource().getString("DashboardView.taskTable.requestor"), String.class, "");
        taskTable.setColumnWidth(PresenterUtils.getMensagensResource().getString("DashboardView.taskTable.requestor"), 80);
        taskTable.addContainerProperty(PresenterUtils.getMensagensResource().getString("DashboardView.taskTable.assingee"), String.class, "");
        taskTable.setColumnWidth(PresenterUtils.getMensagensResource().getString("DashboardView.taskTable.assingee"), 80);
        taskTable.addContainerProperty(PresenterUtils.getMensagensResource().getString("DashboardView.taskTable.startDate"), String.class, "");
        taskTable.setColumnWidth(PresenterUtils.getMensagensResource().getString("DashboardView.taskTable.startDate"), 80);
        taskTable.addContainerProperty(PresenterUtils.getMensagensResource().getString("DashboardView.taskTable.endDate"), String.class, "");
        taskTable.setColumnWidth(PresenterUtils.getMensagensResource().getString("DashboardView.taskTable.endDate"), 80);
        taskTable.addContainerProperty(PresenterUtils.getMensagensResource().getString("DashboardView.taskTable.state"), PopupButton.class, "");
        taskTable.setColumnWidth(PresenterUtils.getMensagensResource().getString("DashboardView.taskTable.state"), 200);
        taskTable.addContainerProperty(PresenterUtils.getMensagensResource().getString("DashboardView.taskTable.forecast"), Character.class, "");
        taskTable.setColumnWidth(PresenterUtils.getMensagensResource().getString("DashboardView.taskTable.forecast"), 30);
        taskTable.addContainerProperty(PresenterUtils.getMensagensResource().getString("DashboardView.taskTable.email"), Button.class, "");
        taskTable.setColumnWidth(PresenterUtils.getMensagensResource().getString("DashboardView.taskTable.email"), 30);
        taskTable.addContainerProperty(PresenterUtils.getMensagensResource().getString("DashboardView.taskTable.chat"), Button.class, "");
        taskTable.setColumnWidth(PresenterUtils.getMensagensResource().getString("DashboardView.taskTable.chat"), 30);

        taskTable.addGeneratedColumn(PresenterUtils.getMensagensResource().getString("DashboardView.taskTable.colunaBotaoRemover"), (Table source, final Object itemId, Object columnId) -> {
        ...
        taskTable.setColumnWidth(PresenterUtils.getMensagensResource().getString("DashboardView.taskTable.colunaBotaoRemover"), 30);
    ...
    private Table buildTargetTable() {
        ...
        configuraExpansaoColunaCodigo(targetTable, PresenterUtils.getMensagensResource().getString("DashboardView.targetTable.cod"));
        ...
        targetTable.addContainerProperty(PresenterUtils.getMensagensResource().getString("DashboardView.targetTable.forecast"), Character.class, "");
